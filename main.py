    ...
    def _load_agents_from_config(self):
        for agent_name in self.config.get('agents', []):
            if agent_name == "OrchestratorAgent":
                # The OrchestratorAgent requires the agent_manager
...
if __name__ == "__main__":
    ...
    # This command will be processed by the OrchestratorAgent,
    # which will use the LLMAgent to create a plan,
    # and then delegate the tasks to the appropriate agents.
